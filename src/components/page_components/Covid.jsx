      ...
      <section id="content-section">
          ...
          <div className="container">
            ...
            <div id="list-content" className="content-box">
              <ul>
                ...
                <li>
                  COVID-19 vaccines have been authorized for emergency use by
                  the U.S. Food and Drug Administration, and vaccination
                  programs are in progress across the U.S. and in many parts of
                  the world.
                </li>
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                ...
                sneezes. Larger droplets may fall to the ground in a few
                seconds, but tiny infectious particles can linger in the air and
                accumulate in indoor places, especially where many people are
                gathered and there is poor ventilation. This is why
                mask-wearing, hand hygiene and physical distancing are essential
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                ...
                several infectious disease outbreaks have been traced to viruses
                originating in birds, pigs, bats and other animals that mutated
                to become dangerous to humans. Research continues, and more
                study may reveal how and why the coronavirus evolved to cause
                pandemic disease.
              </p>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                ...
                Infusions of monoclonal antibodies given to certain patients
                early in the infection may reduce the symptoms, severity and
        ...
        <Slide left>
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                Vaccines are now authorized to prevent infection with
                SARS-CoV-2, the coronavirus that causes COVID-19. But until more
                is understood about how the vaccines affect a person’s ability
                to transmit the virus, precautions such as mask-wearing,
                physical distancing and hand hygiene should continue regardless
                of a person’s vaccination status to help prevent the spread of
                COVID-19. Learn more about the COVID-19 vaccine and ways to
                protect yourself.
              </p>
            </div>
            ...
            <div className="sub-content content-box">
              <p>
                ...
                sneezes, their droplets can infect people nearby. That’s why
                it’s important to avoid close contact with others. Understand
                that people (including children) may be infected with the new
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                ...
                infections, deaths and vaccinations worldwide, see the
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                ...
                “crown.” The virus’s outer layers are covered with spike
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                ...
                ending in 2004. The coronavirus that causes COVID-19 is similar
                to the one that caused the 2003 SARS outbreak. Since the 2019
                ...
                these viruses, but SARS-CoV-2 spreads faster and farther than
                the 2003 SARS-CoV-1 virus. This is likely because of how easily
                it is transmitted person to person, even from asymptomatic
        ...
        <Slide right>
          ...
          <div className="container">
            ...
            <div className="content-box">
              <p>
                Yes, there are different variants of this coronavirus. Like
                other viruses, the coronavirus that causes COVID-19 can change
                (mutate). In December 2020, B.1.1.7, a new variant, was
                identified in the United Kingdom, and since then, variants have
                appeared in other locations around the world, including B.1.351,
                first isolated in South Africa, and others. Mutations may enable
                the coronavirus to spread faster from person to person, and may
                cause more severe disease. More infections can result in more
                people getting very sick and also create more opportunity for
                the virus to develop further mutations. Read more about
